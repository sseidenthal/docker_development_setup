...
sudo apt-get install -y tree mc htop curl wget unison software-properties-common
...
sudo cp /vagrant/.vagrant/templates/unison.service /etc/systemd/system/unison.service
sudo mkdir -p /var/lib/docker/volumes
systemctl daemon-reload

#BUG: this line is problematic, it will prevent provisioning with success, but it works
